...
public class HomeBank {
        public static void main(String[] args) throws MalformedURLException, InterruptedException {
                ...
                // click Bank
                driver.findElement(ByAccessibilityId.accessibilityId("DashboardTile_Bank_Item")).click();
                Thread.sleep(3000);

                // click SBI STC(Collection)
                driver.findElement(ByAccessibilityId.accessibilityId("DashBoardView_SBI STC (Collection)")).click();
                Thread.sleep(5000);

                // click datepicker(previous arrow)
                driver.findElement(ByAccessibilityId.accessibilityId("Back Arrow")).click();
                Thread.sleep(5000);
