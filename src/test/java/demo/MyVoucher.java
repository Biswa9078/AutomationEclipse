...
public class MyVoucher{
	public static void main(String[] args) throws MalformedURLException, InterruptedException {
  	...
  	//find the position where you need to touch
        ...
        // click MyVoucher
        driver.findElement(ByAccessibilityId.accessibilityId("Text_My Vouchers")).click();
        Thread.sleep(3000);
        
        
        // click filter button
        driver.findElement(ByAccessibilityId.accessibilityId("MyVouchers_OpenFilterModal")).click();
        Thread.sleep(2000);
        
        
        // clcik apply
        driver.findElement(ByAccessibilityId.accessibilityId("APPLY")).click();
        Thread.sleep(2000);
        
        
        
        
        System.out.println("Voucher Open Successfully");
        Thread.sleep(4000);
        driver.quit();
