...
public class HomePurchase {
        public static void main(String[] args) throws MalformedURLException, InterruptedException {
                ...
                // click Purchase
                driver.findElement(ByAccessibilityId.accessibilityId("DashboardTile_Purchase_Item")).click();
                Thread.sleep(3000);

                // click ledger(Amiya ku Biswal)
                driver.findElement(ByAccessibilityId.accessibilityId("DashBoardView_Amiya Ku Biswal")).click();
                Thread.sleep(5000);

                // click voucher
                driver.findElement(ByAccessibilityId.accessibilityId("VoucherView_Amiya Ku Biswal_Item")).click();
                Thread.sleep(5000);
