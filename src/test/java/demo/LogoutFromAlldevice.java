...
public class LogoutFromAlldevice {
        public static void main(String[] args) throws MalformedURLException, InterruptedException {
                ...
                // click logout from all device
                driver.findElement(ByAccessibilityId.accessibilityId("Open logout confirmation modal")).click();
                Thread.sleep(3000);

                // click Logout
                driver.findElement(ByAccessibilityId.accessibilityId("Log out from all devices")).click();
                Thread.sleep(3000);
