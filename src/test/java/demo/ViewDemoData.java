...
public class ViewDemoData {
        public static void main(String[] args) throws MalformedURLException, InterruptedException {
                ...
                // select demodata
                driver.findElement(ByAccessibilityId.accessibilityId("TallyCompanies_ViewDemoDataButton")).click();
                Thread.sleep(5000);

                System.out.println("open demo data successfully");
                Thread.sleep(4000);
                driver.quit();
        }
