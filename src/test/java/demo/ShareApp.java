...
public class ShareApp {
  public static void main(String[] args) throws MalformedURLException, InterruptedException {
    ...
    // click Share App
    driver.findElement(ByAccessibilityId.accessibilityId("Item_Share App")).click();
    Thread.sleep(3000);

    // click Share App On Modal
    driver.findElement(ByAccessibilityId.accessibilityId("Share App")).click();
    Thread.sleep(3000);

    System.out.println("Share App Acording to You");
    Thread.sleep(4000);
    driver.quit();
  }
