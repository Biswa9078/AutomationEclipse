...
public class EditProfile {
   ...
   public static void main(String[] args) throws MalformedURLException, InterruptedException {
      ...
      driver.findElement(ByAccessibilityId.accessibilityId("S, Shhhhhhhuppoo, Admin, ")).click();
      Thread.sleep(3000);

      // click edit
      driver.findElement(ByAccessibilityId.accessibilityId("Edit")).click();
      Thread.sleep(2000);

      System.out.println("edit name acccording to you");
      Thread.sleep(4000);
      driver.quit();
