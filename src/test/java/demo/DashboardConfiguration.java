...
public class DashboardConfiguration {
        public static void main(String[] args) throws MalformedURLException, InterruptedException {
                ...
                // click dashboardconfiguration
                driver.findElement(ByAccessibilityId.accessibilityId("Text_Dashboard Configuration")).click();
                Thread.sleep(5000);

                // click sales toggle
                driver.findElement(ByAccessibilityId.accessibilityId("Container for Sales")).click();
                Thread.sleep(2000);
