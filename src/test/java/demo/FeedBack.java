...
public class FeedBack {
  public static void main(String[] args) throws MalformedURLException, InterruptedException {
    ...
    // click Feedback
    driver.findElement(ByAccessibilityId.accessibilityId("Item_Feedback")).click();
    Thread.sleep(3000);

    // description
    WebElement usernameField = driver.findElement(ByAccessibilityId.accessibilityId("Description input field"));
    usernameField.sendKeys("The app’s ability to integrate with multiple platforms is a great feature, "
        + "and the customer support team is always responsive and helpful. Overall,"
        + " Tally has significantly improved the way I manage my business finances,"
        + " and I highly recommend it to anyone looking for reliable accounting software.");
    Thread.sleep(5000);

    // click Submit
    driver.findElement(ByAccessibilityId.accessibilityId("Centered container with padding")).click();
    Thread.sleep(3000);
