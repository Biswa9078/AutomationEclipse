...
public class DayBook {
        public static void main(String[] args) throws MalformedURLException, InterruptedException {
                ...
                // reportdaybook
                driver.findElement(ByAccessibilityId.accessibilityId("Text_Day Book")).click();
                Thread.sleep(3000);

                // click voucher
                driver.findElement(ByAccessibilityId.accessibilityId("DayBook_3ps Beauty Solutions, Cuttack_Item"))
                                .click();
                Thread.sleep(5000);
