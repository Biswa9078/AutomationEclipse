...
public class HomePayble {
  public static void main(String[] args) throws MalformedURLException, InterruptedException {
    ...
    // click Payable
    driver.findElement(ByAccessibilityId.accessibilityId("DashboardTile_Payables_Item")).click();
    Thread.sleep(3000);

    // click NameAscending
    driver.findElement(ByAccessibilityId.accessibilityId("Sort ascending")).click();
    Thread.sleep(5000);

    // click Yogeshwar
    driver.findElement(ByAccessibilityId.accessibilityId("DashBoardView_Yogeshwar Machine Tools")).click();
    Thread.sleep(3000);
