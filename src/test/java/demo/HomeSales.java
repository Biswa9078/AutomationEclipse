...
public class HomeSales {
        public static void main(String[] args) throws MalformedURLException, InterruptedException {
                ...
                // click Sales
                driver.findElement(ByAccessibilityId.accessibilityId("DashboardTile_Sales_Item")).click();
                Thread.sleep(3000);

                // click 3ps Beauty
                driver.findElement(ByAccessibilityId.accessibilityId("DashBoardView_3ps Beauty Solutions, Cuttack"))
                                .click();
                Thread.sleep(5000);
