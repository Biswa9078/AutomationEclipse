...
public class InactiveCustomer {
  public static void main(String[] args) throws MalformedURLException, InterruptedException {
    ...
    // inactive customer
    driver.findElement(ByAccessibilityId.accessibilityId("Text_Inactive Customers")).click();
    Thread.sleep(3000);

    // click one ledger
    driver.findElement(ByAccessibilityId.accessibilityId("InactiveCustomers_Aarushi Sanitary, Khurdha_Item")).click();
    Thread.sleep(5000);
